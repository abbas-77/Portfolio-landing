  ...
  return (
    <div>
      <div className="header">
        ...
        <div className="menu">
          <div className="menu-items" ref={el => menu_item1 = el}>About</div>
          <div className="menu-items" ref={el => menu_item2 = el}>Journal</div>
          <div className="menu-items" ref={el => menu_item3 = el}>Contact</div>
        </div>
      </div>
    </div>
  );
